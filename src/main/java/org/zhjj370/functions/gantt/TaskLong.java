 ...
 */
public class TaskLong implements Cloneable, PublicCloneable, Serializable {
    ...
    private TimePeriodLong duration;
     ...
     */
    public TaskLong(String description, TimePeriodLong duration) {
     ...
     */
    /*public TaskInt(String description, Date start, Date end) {
     ...
     */
    public TimePeriodLong getDuration() {
     ...
     */
    public void setDuration(TimePeriodLong duration) {
        this.duration = duration;
    }
     ...
     * @return The sub-task.
     */
    public TaskLong getSubtask(int index) {
        return (TaskLong) this.subtasks.get(index);
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TaskLong)) {
            return false;
        }
        TaskLong that = (TaskLong) object;
