 ...
 */
public class SimpleTimePeriodLong implements TimePeriodLong, Comparable, Serializable {
     ...
     */
    public SimpleTimePeriodLong(long start, long end) {
        if (start > end) {
     ...
     */
    /*public SimpleTimePeriodLong(Date start, Date end) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TimePeriodLong)) {
            return false;
        }
        TimePeriodLong that = (TimePeriodLong) obj;
